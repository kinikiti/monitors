...
def main():
    ...
    # Note: should only contain a-z, 0-9 and _ characters
    event_type_watsonstudio_runtime_usage_total_count = cp4d_monitor.create_and_validate_type(
        "cp4d_watsonstudio_runtime_usage_total_count")
    event_type_watsonstudio_runtime_usage_project_count = cp4d_monitor.create_and_validate_type(
        'cp4d_watsonstudio_runtime_usage_project_count')
    event_type_watsonstudio_runtime_usage_project_cpu = cp4d_monitor.create_and_validate_type(
        'cp4d_watsonstudio_runtime_usage_project_cpu')
    event_type_watsonstudio_runtime_usage_project_memory = cp4d_monitor.create_and_validate_type(
        "cp4d_watsonstudio_runtime_usage_project_memory")
    event_type_watsonstudio_runtime_usage_cpu = cp4d_monitor.create_and_validate_type(
        "cp4d_watsonstudio_runtime_usage_cpu")
    event_type_watsonstudio_runtime_usage_memory = cp4d_monitor.create_and_validate_type(
        ...
        if len(pods) > 0:
            ...
            for pod in pods:
                ...
                events.append({"monitor_type": monitor_type,
                               ...
                               "metadata": metadata_watsonstudio_runtime_usage_cpu.format(pod_cpu_limits,
                                                                                          pod_cpu_requests,
                                                                                          pod_cpu_usage),
                               "severity": "info",
                ...
                events.append({"monitor_type": monitor_type,
                               ...
                               "metadata": metadata_watsonstudio_runtime_usage_memory.format(pod_memory_limits,
                                                                                             pod_memory_requests,
                                                                                             pod_memory_usage),
                               "severity": "info",
                               "reference": project['entity']['name'] + '_' + pod['metadata']['name']})
            ...
            events.append({"monitor_type": monitor_type,
                           ...
                           "metadata": metadata_watsonstudio_runtime_usage_project_cpu.format(project_total_cpu_limits,
                                                                                              project_total_memory_requests,
                                                                                              project_total_cpu_usage),
                           "severity": "info",
                           "reference": project['entity']['name']})
            events.append({"monitor_type": monitor_type,
                           "event_type": event_type_watsonstudio_runtime_usage_project_memory,
                           "metadata": metadata_watsonstudio_runtime_usage_project_memory.format(
                               project_total_memory_limits, project_total_memory_requests, project_total_memory_usage),
                           "severity": "info",
                           "reference": project['entity']['name']})
        events.append({"monitor_type": monitor_type,
